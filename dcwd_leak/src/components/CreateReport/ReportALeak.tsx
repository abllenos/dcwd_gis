        ...
        >
          <Row gutter={24}>
            <Col span={10}>
              ...
              <Row gutter={16}>
                <Col span={12}> 
                  <Form.Item name="refAccNo" label={<span style={labelStyle}>Rec Address</span>}>
                    <Input disabled />
                  </Form.Item>
                </Col>   
                <Col span={12}>
            ...
            <Col span={14}>
              ...
              <div style={{ height: 625, border: '1px solid #ccc', marginBottom: 24 }}>
                <MapComponent lat={lat} lng={lng} onMapClick={handleMapClick} />
              </div>

              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
                <Button danger  onClick={() => { form.resetFields();}}>Cancel</Button>
