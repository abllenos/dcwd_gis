...
const handleMenuClick: MenuProps['onClick'] = ({ key }) => {
  ...
  const dataLayers: MenuItem[] = [
    ...
    createLinkItem('sub2-6', 'Fire Hydrant', '/FireHydrant'),
    createLinkItem('sub2-7', 'Isolation Valve', '/Isolation'),
    ...
    createLinkItem('sub2-13', 'Distribution & Transmission Valve', '/Distribution'),
